...
/**
 * This class represents a summerHouse object, which extends the properties and methods of the HouseSuperClass.
 * It has an additional property, id, which represents a unique identifier for each house object.
 */
public class SummerHouse extends HouseSuperClass {

    private int id;

    // constructor that initializes the properties inherited from subclass.House and the new property
    public SummerHouse(double price, double squareMeter, int numberOfRooms, int numberOfHalls, int id) {
